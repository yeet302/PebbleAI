      ...
      <div className="max-w-md w-full text-center space-y-8">
        ...
        <div className="space-y-3">
          ...
          <a
            ...
            className="w-full flex items-center justify-center gap-3 rounded-2xl bg-white border-2 border-gray-200 px-8 py-5 hover:border-blue-400 hover:bg-blue-50 transition-colors group shadow-sm"
          >
            ...
            <div className="text-left">
              <p className="font-semibold text-gray-800 group-hover:text-blue-700">Connect Google Calendar</p>
          ...
          <button
            ...
            className="w-full rounded-2xl border-2 border-dashed border-gray-300 px-8 py-6 hover:border-blue-400 hover:bg-blue-50 transition-colors group"
          >
            <div className="flex flex-col items-center gap-2">
              ...
              <div>
                <p className="font-semibold text-gray-700 group-hover:text-blue-600">Import .ics file</p>
